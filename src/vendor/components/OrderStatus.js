    ...
    return (
        <div>
              <div className="row order-list">
                ...
                <div className="col-3">
                    <Link onClick={() => redirect(0 , 0)} to={`/vendor/order/${1}`}>
                    <ul  className="order-card">
                        <li className="refer">ABCD1234</li>
                        <li className="date">17th January, 2021</li>
                        <li className="cash"><img src={cash} alt=""/>N/A</li>
                        <li className="cash"><img src={status} alt=""/>PENDING</li>
                    </ul>
                    </Link>
                </div>
                <div className="col-3">
