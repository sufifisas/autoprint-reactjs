    ...
    axios
          ...
          .then(response => {
                    ...
                    if(response.status === 200){
                        ...
                        setText("Your order has been successfuly completed");
                        setSuccess(true)
                        setLoading(false)
                        setResult(true)      
          }})
      ...
      >
        <Fade in={open}>
          <div className={classes.paper}>
            ...
            <p id="transition-modal-description">Are you sure to complete this order? Please make sure you have done all the print request for this order before proceed.</p>
